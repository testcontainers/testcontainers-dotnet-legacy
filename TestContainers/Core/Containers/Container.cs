...
namespace TestContainers.Core.Containers
{
    public class Container
    {
        ...
        public List<(string key, string value)> EnvironmentVariables { get; set; }
        public ContainerInspectResponse ContainerInspectResponse { get; set; }

        public Container() =>
            _dockerClient = DockerClientFactory.Instance.Client();

        public Container(string dockerImageName) : this() => DockerImageName = dockerImageName;
        ...
        public string GetContainerIpAddress() => ContainerInspectResponse.NetworkSettings.Networks.First().Value.IPAddress;
